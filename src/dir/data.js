...
const dexie = new Dexie({init: true, routine: true, debug: false, ben: 'str', version: 1, proto, id, name: 'test', schema: {posts: 'iden, stamp, edit, user, text, *list, *for, *tags'}, sync: false})
