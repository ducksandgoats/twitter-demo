...
const dexie = new Dexie({init: false, routine: false, debug: true, ben: 'str', version: 1, proto, id, name: 'test', schema: {posts: 'iden, stamp, edit, user, text, *list, *for, *tags'}, sync: false})
